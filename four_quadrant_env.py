"""
Four Quadrant Game - 直接Gymnasium環境として実装
画面を4分割し、1区画だけ赤色、残りは白色
赤色クリック→報酬+1、白色クリック→報酬-1、時間切れ→報酬-2
"""
...
class FourQuadrantEnv(gym.Env):
    ...
    def __init__(self, render_mode):
        ...
        # Pygame初期化（render_modeに関わらず画面配列取得のため必要）
        pygame.init()
