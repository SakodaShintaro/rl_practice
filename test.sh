...
uv run python scripts/train.py exp_name=test debug=true batch_size=2 agent_type=on_policy network_class=actor_critic_with_state_value policy_type=beta
