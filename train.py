...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--predictor_type", type=str, default="linear", choices=["linear", "dit"])
    parser.add_argument("--predictor_step_num", type=int, default=50)
...
def main(args, exp_name: str, seed: int) -> None:
    ...
    for episode_id in range(10000):
        ...
        while True:
            ...
            if obs_l1_loss is not None:
                data_dict["losses/obs_l1_loss"] = obs_l1_loss
            wandb.log(data_dict)
