...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--seq_len", type=int, default=5, help="Number of images per inference step"
    )
    parser.add_argument(
        "--tokens_per_step", type=int, default=5, help="Tokens to generate per step"
    )
    parser.add_argument(
        "--max_context_words", type=int, default=100, help="Max words to keep in context"
    )
