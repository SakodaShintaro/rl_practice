"""Online Batch Gradient Descent optimizers for streaming RL.

Based on https://github.com/mohmdelsayed/streaming-drl/blob/main/stream_ac_continuous.py
License: https://github.com/mohmdelsayed/streaming-drl/blob/main/LICENSE.md
"""
